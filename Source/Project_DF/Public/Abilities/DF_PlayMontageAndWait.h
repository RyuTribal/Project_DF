...
#include "DF_PlayMontageAndWait.generated.h"

class UDF_AbilitySystemComponent;
 ...
 */
UCLASS()
class PROJECT_DF_API UDF_PlayMontageAndWait : public UAbilityTask
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	UDF_PlayMontageAndWait(const FObjectInitializer& ObjectInitializer);
	...
	UFUNCTION(BlueprintCallable, Category = "Ability|Tasks", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
		static UDF_PlayMontageAndWait* PlayMontageAndWaitForEvent(
...
private:
	...
	UDF_AbilitySystemComponent* GetTargetASC();
